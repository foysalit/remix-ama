...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create ama-remix-9c55
  fly create ama-remix-9c55-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ama-remix-9c55
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ama-remix-9c55-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'ama-remix-9c55-staging' does not match app name in config file 'ama-remix-9c55'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name ama-remix-9c55-db
  fly postgres attach --postgres-app ama-remix-9c55-db --app ama-remix-9c55

  fly postgres create --name ama-remix-9c55-staging-db
  fly postgres attach --postgres-app ama-remix-9c55-staging-db --app ama-remix-9c55-staging
  ```
